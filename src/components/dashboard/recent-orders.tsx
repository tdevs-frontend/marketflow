                  ...
                  <TR key={order.id} className="group">
                    ...
                    <TD className="whitespace-nowrap">
                      <Link
                        ...
                        className="inline-flex items-center gap-1.5 tabular-nums text-text-primary transition-colors hover:text-primary group-hover:text-primary focus-visible:shadow-focus focus-visible:outline-none"
                      >
                        <ChannelIcon
