...
export function AnalyticsSection() {
  return (
    ...
    >
      ...
      <div
        aria-hidden
        className="pointer-events-none absolute top-1/2 left-1/2 -z-10 size-224 -translate-x-1/2 -translate-y-1/2 rounded-full bg-[radial-gradient(closest-side,rgba(20,184,166,0.08),transparent)]"
      />
