...
type Kpi = { label: string; value: string; change: string; icon: LucideIcon };

const KPIS: Kpi[] = [
  { label: "Total Leads", value: "12,480", change: "+18.4%", icon: Users },
  { label: "WhatsApp Conversations", value: "8,420", change: "+24.6%", icon: MessageCircle },
  { label: "Conversion Rate", value: "24.8%", change: "+8.2%", icon: TrendingUp },
  { label: "Revenue Generated", value: "$48.2K", change: "+21.5%", icon: DollarSign },
];
      ...
      {KPIS.map((kpi) => (
        <Panel key={kpi.label} className="p-4">
          <div className="flex items-start justify-between gap-3">
            <dt className="text-xs font-medium text-text-secondary">{kpi.label}</dt>
    ...
    <Panel className="flex flex-col justify-between bg-primary-soft/40">
      <div>
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-bold text-text-primary">Growth Insight</h3>
        </div>
      ...
      <p className="group mt-4 inline-flex items-center gap-1.5 text-xs font-semibold text-primary">
