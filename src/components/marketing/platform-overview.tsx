  ...
  return (
    ...
    >
      ...
      <div className="custom-container">
        ...
        {/* Journey */}
        <ol className="mt-14 flex flex-wrap items-center justify-center gap-x-2 gap-y-3 rounded-card border border-border bg-surface px-5 py-4 shadow-card sm:gap-x-4">
